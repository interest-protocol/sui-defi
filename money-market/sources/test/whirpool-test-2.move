...
module money_market::ipx_money_market_test_2 {
  ...
  fun test_repay_suid() {
    ...
    next_tx(test, alice);
    {
      ...
      let coin_ipx = money_market::repay_suid(
        &mut money_market_storage,
        &mut ipx_storage,
        &mut suid_storage,
        &clock_object,
  ...
  fun test_liquidate() {
    ...
    next_tx(test, alice);
    {
     ...
     next_tx(test, bob);
     {
      ...
      money_market::liquidate<BTC, ETH>(
        &mut money_market_storage,
        &interest_rate_model_storage,
        &mut ipx_storage,
        price_potato_vector,
  ...
  fun test_liquidate_error_dinero_collateral() {
    ...
    next_tx(test, alice);
    {
      ...
      money_market::liquidate<SUID, ETH>(
        &mut money_market_storage,
        &interest_rate_model_storage,
        &mut ipx_storage,
        get_all_prices_potatoes(),
  ...
  fun test_liquidate_error_dinero_loan() {
    ...
    next_tx(test, alice);
    {
      ...
      money_market::liquidate<ETH, SUID>(
        &mut money_market_storage,
        &interest_rate_model_storage,
        &mut ipx_storage,
        get_all_prices_potatoes(),
  ...
  fun test_liquidate_error_borrow_no_collateral_account() {
    ...
    next_tx(test, alice);
    {
      ...
      money_market::liquidate<ETH, BTC>(
        &mut money_market_storage,
        &interest_rate_model_storage,
        &mut ipx_storage,
        get_all_prices_potatoes(),
...
#[test]
  ...
  fun test_liquidate_suid() {
    ...
    next_tx(test, alice);
    {
     ...
     next_tx(test, bob);
     {
      ...
      money_market::liquidate_suid<BTC>(
        &mut money_market_storage,
        &interest_rate_model_storage,
        &mut ipx_storage,
        &mut suid_storage,
  ...
  fun test_liquidate_suid_error_suid_collateral() {
    ...
    next_tx(test, alice);  
    {
      ...
      money_market::liquidate_suid<SUID>(
        &mut money_market_storage,
        &interest_rate_model_storage,
        &mut ipx_storage,
        &mut suid_storage,
