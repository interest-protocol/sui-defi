...
module clamm::ipx_pool_tests {
  ...
  //     let sqrt_price_low = create_sqrt_price(4545);
  //     let sqrt_price_current = create_sqrt_price(5000);
  //     let sqrt_price_high = create_sqrt_price(5500);

  //     let liq0 = liquidity0(1000000000, sqrt_price_current, sqrt_price_high);
  //     let liq1 = liquidity1(5000000000000, sqrt_price_current, sqrt_price_low);
