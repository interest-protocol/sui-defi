...
module interest_protocol::dnr {
  ...
  *
  */
  entry fun add_minter(_: &DineroAdminCap, storage: &mut DineroStorage, publisher: &Publisher) {
  ...
  *
  */
  entry fun remove_minter(_: &DineroAdminCap, storage: &mut DineroStorage, publisher: &Publisher) {
