...
module interest_protocol::whirpool_tests {
  ...
  //     assert_eq(dnr_per_epoch, 30000000 / get_epochs_per_year());
  ...
  //     let interest_rate_per_epoch = whirpool::get_borrow_rate_per_epoch<DNR>(
  //       &whirpool_storage,
  //       &interest_rate_model_storage,
  //       &dnr_storage
  //     );

  //     let (_, _, _, _, _, _, _, _, _, _, _, _, _, total_principal, total_borrows) = whirpool::get_market_info<DNR>(&whirpool_storage);
  ...
  //     // 5 epoch rewards
  //     let loan_rewards_per_share = calculate_dnr_market_rewards(5, 60000 * DNR_DECIMALS_FACTOR);
  ...
  //     let (_, _, _, _, _, _, _, _, _, _, prev_loan_rewards_per_share, _, _, total_principal, total_borrows) = whirpool::get_market_info<DNR>(&whirpool_storage);
  ...
  //     // 5 epoch rewards
  //     let loan_rewards_per_share = calculate_dnr_market_rewards(4, (total_principal as u256)) + prev_loan_rewards_per_share;
  ...
  //     let (_, _, _, _, _, _, _, _, _, _, prev_loan_rewards_per_share, _, _, _, _) = whirpool::get_market_info<DNR>(&whirpool_storage);
  ...
  //       &mut ipx_storage,
  //       &mut dnr_storage,
  //       mint<DNR>(5100, DNR_DECIMALS, ctx(test)),
  //       (5000 * DNR_DECIMALS_FACTOR as u64),
  //       ctx(test)
  //     );

  //     let loan_rewards_per_share = calculate_dnr_market_rewards(7, 5000 * DNR_DECIMALS_FACTOR) + prev_loan_rewards_per_share;
  //     let (_, loan, _, loan_rewards_paid) = whirpool::get_account_info<DNR>(&account_storage, alice);
  ...
  fun calculate_eth_market_rewards(timestamp_delta: u256, total_principal: u256): u256 {
